  ...
  test("Translation with text and locale fields", function(done) {
    chai
      ...
      .end(function(err, res) {
        ...
        assert.equal(res.body.text, "blue is my favorite color");
        assert.equal(res.body.translation, "blue is my <span class=\"highlight\">favourite</span> <span class=\"highlight\">colour</span>");
        done();
      });
  });
